...
(4000 ms), `TYPE` (16 ms a character), all stretched by `PACE` (1.3, so about 17 s of acts and a 5 s hold). The picture is aria-hidden; a visually hidden sentence describes it.
